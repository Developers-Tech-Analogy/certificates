    ...
    <div className={[styles.content, "min-h-screen flex bg-black"].join(" ")}>
      ...
      <div className="group xl:w-2/5 rounded-lg mx-12 my-12 xl:ml-16 xl:mr-72 xl:mt-44">
        <div>
          ...
          <p className="text-sm font-light py-2 text-white">
            Certificate ID is the last 10 digits of the certificate verify link.
          </p>
          <p className="text-sm font-light py-2 text-white">
            Example : ID for{" "}
            <a
              href="https://certificates.techanalogy.org/verify/IRFa-VaY2e"
              target="_blank"
              className="duration-700 hover:underline"
              rel="noreferrer"
            >
              https://certificates.techanalogy.org/verify/IRFa-VaY2e
            </a>{" "}
            is IRFa-VaY2e
          </p>
        </div>
